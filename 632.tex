...
{\Huge \bfseries \title{\textit{\textbf{A literature review of web mining}}}}
\author{Isaac Kamga\\
Department of Computer Science\\
University of Buea\\
Cameroon.\\ }

\date{\textit{January 10 2011}}
...
\begin{inparaenum}[1.]
    \item The invention of the internet and the explosion in the size, complexity and popularity of web data.\\
    \item The proliferation, ubiquity and increasing potency of information and communication technologies (ICTs) has increased data collection and storage.\\
    \item The need for users to utilize automated tools to get desired information and break free from the  data rich but information poor phenomenon.\\
\end{inparaenum}
