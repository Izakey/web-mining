...
\begin{itemize}
\item 1. Features of predecessor pages should not be considered as shown by Chakrabarti \textit{et al}(1998a).
\item 2. The entire text of the predecessor page may not be relevant.
\item 3. Not all pages have relevant meta-information.
\end{itemize}
